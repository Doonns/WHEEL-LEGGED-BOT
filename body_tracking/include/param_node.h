 ...
 public:
  ParametersClass(
    ...
    if (cfg_) {
      ...
      // 新增
      this->declare_parameter<double>("feature_match_threshold", cfg_->feature_match_threshold);
  ...
  void Respond() {
    ...
    // 新增
    this->get_parameter("feature_match_threshold", cfg_->feature_match_threshold);
    std::stringstream ss;
